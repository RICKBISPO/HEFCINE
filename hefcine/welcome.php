        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="dropdown dropstart">
            <a class="navbar-brand dropdown-toggle" href="#" data-bs-toggle="dropdown" style="padding-left: 20px;">
              <img src="imghef/profile.jpg" alt="Perfil" style="width:40px;" class="rounded-circle" title="<?php echo $_SESSION["id"]; ?>" >
            </a>
            ...
            <div class="card" style="width: 14rem;">
              <div class="card-img-top text-center pt-2" >
                <?php
                  ...
                  // ajustando a instruçăo select para ordenar por produto
                  $query = mysqli_query($conexao,"select * from filmeserie where idFIlmeSerie= '20' and tipo= 'filme'");
            ...
            <div class="card" style="width: 14rem;">
              <div class="card-img-top text-center pt-2" >
                <?php
                  ...
                  // ajustando a instruçăo select para ordenar por produto
                  $query = mysqli_query($conexao,"select * from filmeserie where idFIlmeSerie= '17' and tipo= 'filme'");
            ...
            <div class="card" style="width: 14rem;">
              <div class="card-img-top text-center pt-2" >
                <?php
                  ...
                  // ajustando a instruçăo select para ordenar por produto
                  $query = mysqli_query($conexao,"select * from filmeserie where idFIlmeSerie= '21' and tipo= 'serie'");
